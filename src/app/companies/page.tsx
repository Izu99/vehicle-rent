...
export default function CompaniesPage() {
  ...
  const companies = [
    {
      ...
      category: "Luxury",
      image: "https://images.unsplash.com/photo-1560179707-f14e90ef3623?q=80&w=1469&auto=format&fit=crop&ixlib=rb-4.0.3",
      ...
      description: "Premium luxury car rental service with high-end vehicles and exceptional customer service.",
      features: ["24/7 Support", "Chauffeur Service", "Airport Pickup", "Insurance Included"],
    ...
    },
    {
      ...
      category: "Economy",
      image: "https://images.unsplash.com/photo-1449824913935-59a10b8d2000?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3",
      logo: "https://images.unsplash.com/photo-1599305445671-ac291c95aaa9?q=80&w=1469&auto=format&fit=crop&w=100&h=100&ixlib=rb-4.0.3",
      rating: 4.6,
      reviews: 856,
      fleetSize: "300+",
      ...
      description: "Affordable car rental solutions for budget-conscious travelers across Sri Lanka.",
      features: ["Best Price Guarantee", "Free Cancellation", "Multiple Locations", "Online Booking"],
    ...
    },
    {
      ...
      description: "Sri Lanka's first fully electric and hybrid vehicle rental company promoting sustainable transportation.",
      features: ["Eco-Friendly Fleet", "Carbon Neutral", "Charging Stations", "Green Certification"],
    ...
    },
    {
      ...
      description: "Specialized in family-friendly vehicles and group transportation with spacious vans and SUVs.",
      features: ["Child Safety Seats", "Group Discounts", "Large Capacity", "Tour Packages"],
    ...
    },
    {
      ...
      description: "Exclusive collection of sports cars and supercars for special occasions and luxury experiences.",
      features: ["Exotic Cars", "Special Events", "Photo Shoots", "VIP Service"],
    ...
    },
    {
      ...
      description: "Professional car rental service catering to business travelers and corporate clients.",
      features: ["Corporate Rates", "Monthly Rentals", "Airport Service", "Professional Drivers"],
  ...
  const filteredCompanies = companies.filter(company => {
    const matchesLocation = !filters.location || 
      company.locations.some(loc => loc.toLowerCase().includes(filters.location.toLowerCase()))
    ...
    <div className="min-h-screen gradient-background text-gray-900">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          >
            ...
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">
              Discover {companies.length}+ verified car rental companies across Sri Lanka, each offering unique services and competitive rates
            </p>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          >
            {[
              { icon: <Building className="w-8 h-8" />, number: "50+", label: "Partner Companies" },
              { icon: <Car className="w-8 h-8" />, number: "1000+", label: "Total Fleet Size" },
              { icon: <MapPin className="w-8 h-8" />, number: "25+", label: "Cities Covered" },
              { icon: <Shield className="w-8 h-8" />, number: "100%", label: "Verified Partners" }
            ].map((stat, index) => (
              <motion.div
                key={index}
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-start justify-between mb-3">
                        <div>
                          ...
                          <p className="text-accent text-sm font-medium">{company.category}</p>
                        </div>
                      ...
                      <div className="mb-4">
                        <div className="flex flex-wrap gap-2">
                          ...
                          {company.features.length > 2 && (
                            <span className="text-xs text-gray-500">+{company.features.length - 2} more</span>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="flex space-x-2">
                        ...
                        <Button variant="outline" className="px-4 border-gray-300 text-gray-600 hover:bg-gray-100">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-black mb-4">
              Want to Join Our <span className="text-white">Partner Network?</span>
            </h2>
            <p className="text-black/80 text-lg mb-8">
              List your car rental business on Skyline and reach thousands of customers
            </p>
