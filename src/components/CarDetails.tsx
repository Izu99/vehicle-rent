...
export default function CarDetailsModal({ isOpen, car, onClose }: CarDetailsModalProps) {
        ...
        <div className="overflow-y-auto max-h-[90vh] scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-transparent">
          ...
          <div className="bg-gradient-to-br from-primary/90 via-primary to-accent text-black p-6 pb-8">
            <div className="flex items-center justify-between">
              <div>
                <h1 className="text-3xl font-black mb-2 text-gray-900">{car.brand} {car.carModel}</h1>
                <div className="flex items-center gap-3">
                  <div className="flex items-center">
                    <Star className="w-4 h-4 fill-yellow-400 text-yellow-400 mr-1" />
                    <span className="text-sm text-gray-700">4.5 (120 reviews)</span>
                  </div>
                  <Badge className={`${car.isAvailable ? 'bg-green-500' : 'bg-red-500'} text-white border-0`}>
                ...
                {car.images.length > 0 ? (
                  ...
                  <div className="w-full h-full flex items-center justify-center text-gray-400">
                    <div className="text-center">
                      ...
                      <p className="font-semibold">{car.brand} {car.carModel}</p>
                    </div>
                  </div>
                )}
              </div>
                ...
                <div className="space-y-3">
                  <div className="flex justify-between items-center p-4 bg-gradient-to-r from-primary/10 to-accent/10 rounded-xl border border-primary/20">
                    <div>
                      ...
                      <div className="text-xs text-gray-600">Perfect for short trips</div>
                    </div>
                  ...
                  {car.pricePerWeek && (
                    <div className="flex justify-between items-center p-4 bg-gray-50 rounded-xl">
                      <div>
                        ...
                        <div className="text-xs text-gray-600">Save on longer rentals</div>
                      </div>
                      <div className="text-right">
                        <div className="text-xl font-bold text-green-600">${car.pricePerWeek}</div>
                  ...
                  {car.pricePerMonth && (
                    <div className="flex justify-between items-center p-4 bg-gray-50 rounded-xl">
                      <div>
                        ...
                        <div className="text-xs text-gray-600">Best value option</div>
                      </div>
                      <div className="text-right">
                        <div className="text-xl font-bold text-blue-600">${car.pricePerMonth}</div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-200">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <div className={`flex items-center text-xs py-2 px-3 rounded-lg ${car.airConditioning ? 'bg-green-50 text-green-700' : 'bg-gray-50 text-gray-500'}`}>
                    <CheckCircle className="w-4 h-4 mr-2" />
                    AC
                  </div>
                  <div className={`flex items-center text-xs py-2 px-3 rounded-lg ${car.bluetooth ? 'bg-green-50 text-green-700' : 'bg-gray-50 text-gray-500'}`}>
                    <CheckCircle className="w-4 h-4 mr-2" />
                    Bluetooth
                  </div>
                  <div className={`flex items-center text-xs py-2 px-3 rounded-lg ${car.gps ? 'bg-green-50 text-green-700' : 'bg-gray-50 text-gray-500'}`}>
                    <CheckCircle className="w-4 h-4 mr-2" />
                    GPS
                  </div>
                  <div className={`flex items-center text-xs py-2 px-3 rounded-lg ${car.sunroof ? 'bg-green-50 text-green-700' : 'bg-gray-50 text-gray-500'}`}>
                    <CheckCircle className="w-4 h-4 mr-2" />
                    Sunroof
                  </div>
                </div>
              ...
              <div className="bg-white rounded-2xl p-5 shadow-sm border border-gray-200">
                ...
                <div className="space-y-4">
                  {/* Shop Name with Icon */}
                  <div className="flex items-center">
                    <div className="w-10 h-10 bg-gradient-to-br from-primary to-accent rounded-full flex items-center justify-center mr-3 flex-shrink-0">
                      <Car className="w-5 h-5 text-black" />
                    </div>
                    <div>
                      <div className="font-semibold text-gray-900">{car.shopId.shopName}</div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3 pl-0">
                    ...
                    <div className="flex items-center">
                      ...
                      <span className="text-sm text-gray-600">{car.shopId.phone}</span>
                    </div>
                    
                    {/* Email */}
                    <div className="flex items-start">
                      <Mail className="w-4 h-4 mr-3 text-blue-500 flex-shrink-0 mt-0.5" />
                      <div className="flex-1 min-w-0">
