        ...
        <div className="w-full max-w-6xl flex items-center justify-center gap-12">
          ...
          >
            <div className="relative">
              ...
              />
              <div className="relative w-32 h-32 bg-gradient-to-r from-primary to-accent rounded-full flex items-center justify-center shadow-xl">
                <Image src="/logo.png" width={110} height={110} className="text-black" alt={"logo"} />
              </div>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-600 text-lg leading-relaxed max-w-md">
                Sri Lanka&apos;s premier car rental marketplace connecting you
                with trusted rental partners
              </p>
            </div>
