...
export default function RegisterPage() {
          ...
          >
            <Card className="p-8 shadow-2xl border-0 bg-white max-w-md">
              ...
              <p className="text-gray-600 mb-4">
                Your {role === "customer" ? "customer" : "rental company"}{" "}
  ...
  return (
    <div>
      <Navbar />
      <div className="min-h-screen bg-gradient-to-b from-gray-50 via-gray-100 to-gray-200 flex items-center justify-center p-4">
        <div className="w-full max-w-4xl">
          ...
          {step === 1 && (
            ...
            >
              <div className="-mt-20">
                <div className="w-40 h-40 bg-gradient-to-r from-primary to-accent rounded-full flex items-center justify-center mx-auto mb-4">
                  <Image src="/logo.png" width={110} height={110} className="w-40 h-40 text-black" alt="logo"/>
                </div>
              ...
              <div className="grid grid-cols-1 mt-10 md:grid-cols-2 gap-6 max-w-2xl mx-auto">
                {/* Customer Option */}
                <motion.div
                  ...
                  className="cursor-pointer p-8 rounded-2xl border-2 border-orange-200 bg-white hover:border-primary/50 transition-all"
                >
                ...
                <motion.div
                  ...
                  className="cursor-pointer p-8 rounded-2xl border-2 border-yellow-200 bg-white hover:border-accent/50 transition-all"
                >
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    {role === "rental-company" && (
                      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        <p className="text-sm text-blue-800">
                          <strong>Next step:</strong> After registration, you'll
                          be able to create your company profile and start
                          adding cars to your fleet.
                        </p>
                      </div>
                    )}
